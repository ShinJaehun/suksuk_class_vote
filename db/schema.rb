...
ActiveRecord::Schema[8.1].define(version: 2026_06_09_010000) do
  ...
  create_table "candidate_tallies", force: :cascade do |t|
    ...
    t.index ["poll_id", "candidate_id"], name: "index_candidate_tallies_on_poll_id_and_candidate_id", unique: true
    t.index ["poll_id"], name: "index_candidate_tallies_on_poll_id"
  end
  ...
  create_table "candidates", force: :cascade do |t|
    ...
    t.bigint "poll_id", null: false
    t.datetime "updated_at", null: false
    t.index ["poll_id", "number"], name: "index_candidates_on_poll_id_and_number", unique: true
  ...
  add_foreign_key "candidate_tallies", "polls"
