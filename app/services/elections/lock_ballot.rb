module Elections
  class LockBallot
    ...
    def call
      validate_lockable(election_progress, current_election_voter)
      ...
      ElectionSession.transaction do
        election_session.with_lock do
          ...
          validate_lockable(locked_progress, locked_voter)
    ...
    def validate_lockable(progress, voter)
      errors.clear
      ...
      errors << "진행 중인 선거 세션만 ballot을 잠글 수 있습니다." unless election_session.in_progress?
      ...
      errors << "이미 ballot이 잠겨 있습니다." if progress&.locked?
    end
